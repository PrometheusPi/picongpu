...
public:
    ...
    /** Electric field of the plane wave laser
     *
    ...
    /** Calculate the Ex(r,t) field here (electric field vector normal 
     *  to interaction plane, which is spanned by laser propagation direction 
     *  and y-axis)
     *
    ...
    /** Calculate the E-field vector of the plane wave laser in SI units.
